...
- **VED0**
The VED0[@kennedy1993considerations] statistic estimates connectedness with the variance of differences of management units effects. The VED between two units $i'$ and $j'$ is defined as
\begin{align*}
\text{VED}_{i'j'} &=
...
- **CRO** @mathur2002 proposed using CR approximates flock connectedness by replacing PEV matrix with the variance of differences of management units estimates. The CR of two management units $i'$ and $j'$ is given by
\begin{align*}
\text{CR}_{i'j'} &=
